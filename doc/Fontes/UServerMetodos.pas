...
{$METHODINFO ON}
  ...
  public
    { Public declarations }
    //Função para retornar a cidade de retirada do veículo
    function Cidades: TStringStream;
    //Função para retornar as informações das Unidades
    ...
    //Função para retornar o valor minimo do grupo
    ...
    // function para retornar a tarifa juntamente com a proteção
...
begin
  try
       ...
       Catalog := ArqIni.ReadString('Opções','Catalog','');
  ...
  try
       ...
       begin
            try
                 ...
                 GerouObjeto:= true;
                 DescricaoTarifa := TJSONArray.Create;
                 Objeto.AddPair('Erro','Erro inesperado método Descrição Tarifas');
                 DescricaoTarifa.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(DescricaoTarifa.ToString));
            end;
       end;
  ...
  try
       ...
       begin
            try
                 ...
                 Unidades := TJSONArray.Create;
                 GerouObjeto := true;
                 Objeto.AddPair('Erro','Erro inesperado método Empresas');
                 Unidades.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(Unidades.ToString));
            end;
       end;
                      ...
                      try
                           ...
                           begin
                                ...
                                begin
                                     ...
                                     Body.Add('<b>Valor Total das Diárias:</b> ' +  FormatFloat('R$ ###,###,##0.00',Periodo * (qryConsultaReservaValorPeriodoVeiculo.Value / qryTarifaPeriodoTarifa.Value))  + '<br>');
                                     ...
                                     Body.Add(' como taxa, multas de trânsito e outras previstas no contrato de locação.<br>');
                                     ...
                                     Body.Add(' mantidas as condições da reserva.<br>');
                                     ...
                                     Body.Add('10 – Devolução do carro em outra localidade é necessária autorização prévia e expressa da Locadora e pagamento de taxa de retorno,');
                                     Body.Add(' acrescida de eventual pedágio, ou valores pré-acordados.<br>');
...
begin
  try
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Nome do Cliente é obrigatório.'));
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Email do Cliente é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       if Telefone = '' then
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Telefone do Cliente é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Codigo Empresa do Cliente é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Codigo Unidade do Cliente é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       if not ConectaBanco then
...
//                      end;
            ...
            //Abre a query de municipios para realizar a busca do município
  ...
  try
       ...
       begin
            try
                 ...
                 begin
                      Objeto := TJSONObject.Create;
                      Objeto.AddPair('Erro', TJSONString.Create('CodigoReserva é obrigatório.'));
                      Erro.AddElement(Objeto);
                      GerouObjeto := true;
                 end;
                 ...
                 begin
                      Objeto := TJSONObject.Create;
                      Objeto.AddPair('Erro', TJSONString.Create('CodigoServicoAdicional é obrigatório.'));
                      Erro.AddElement(Objeto);
                      GerouObjeto := true;
                 end;
                 if Erro.Size > 0 then
                 ...
                 ServicoAdicional := TJSONArray.Create;
                 GerouObjeto := true;
                 Objeto.AddPair('Erro','Erro Gravar Serviço Adicional Reserva');
                 ServicoAdicional.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(ServicoAdicional.ToString));
            end;
       end;
...
begin
  try
       ...
       begin
            ...
            GerouObjeto := true;
            Objeto.AddPair('Erro','Código da Empresa é obrigatório.');
       ...
       begin
            try
                 ...
                 GrupoVeiculos := TJSONArray.Create;
                 GerouObjeto := true;
                 Objeto.AddPair('Erro','Erro inseperado método Grupo Veículos');
                 GrupoVeiculos.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(GrupoVeiculos.ToString));
            end;
       end;
  ...
  try
       ...
       begin
            try
                 ...
                 Protecoes := TJSONArray.Create;
                 GerouObjeto:= true;
                 Objeto.AddPair('Erro','Erro método Protecoes');
                 Protecoes.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(Protecoes.ToString));
            end;
       end;
...
begin
  try
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Empresa é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       if CodigoUnidade <= 0 then
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Unidade é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Cliente é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Grupo é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Proteção é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Tarifa é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Data Início é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Data Término é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       if HoraInicio = '' then
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Hora Início é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       if HoraTermino = '' then
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Hora Término é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Município Retirada é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('Município Devolução é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       ...
       begin
            Objeto := TJSONObject.Create;
            Objeto.AddPair('Erro', TJSONString.Create('O Tipo de operação é obrigatório.'));
            Erro.AddElement(Objeto);
            GerouObjeto := true;
       end;
       if Erro.Size > 0 then
       ...
       begin
            try
                 ...
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(ServicosAdicionais.ToString));
                  ...
                  ServicosAdicionais := TJSONArray.Create;
                  GerouObjeto:= false;
                  Objeto.AddPair('Erro','Erro inesperado método Serviços Adicionais');
                  ServicosAdicionais.AddElement(Objeto);
                  Result := TStringStream.Create(TEncoding.UTF8.GetBytes(ServicosAdicionais.ToString));
            end;
       end;
  ...
  try
       ...
       begin
            try
                 ...
                 Adicionais := TJSONArray.Create;
                 GerouObjeto:= true;
                 Objeto.AddPair('Erro','Erro método Serviços Adicionais Reserva');
                 Adicionais.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(Adicionais.ToString));
            end;
       end;
  ...
  try
       ...
       begin
            try
                 ...
                 Tarifas := TJSONArray.Create;
                 GerouObjeto:= true;
                 Objeto.AddPair('Erro','Erro insperado método Tarifas');
                 Tarifas.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(Tarifas.ToString));
            end;
       end;
  ...
  try
       ...
       begin
            try
                 ...
                 Valor := TJSONArray.Create;
                 GerouObjeto := true;
                 Objeto.AddPair('Erro','Erro insperado método Valor Mínimo Grupo');
                 Valor.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(Valor.ToString));
            end;
       end;
       ...
       begin
            try
                 ...
                 begin
                      ...
                      Objeto := TJSONObject.Create;
                      GerouObjeto := true;
                      Objeto.AddPair('Cliente','Cliente não cadastrado');
                      Cliente.AddElement(Objeto);
                      Result := TStringStream.Create(TEncoding.UTF8.GetBytes(Cliente.ToString));
                 end
                 else
                 ...
                 Cliente := TJSONArray.Create;
                 GerouObjeto := true;
                 Objeto.AddPair('Erro','Erro método Verifica Cliente Cadastrado');
                 Cliente.AddElement(Objeto);
                 Result := TStringStream.Create(TEncoding.UTF8.GetBytes(Cliente.ToString));
            end;
       end;
