const Validators = {
    cpf: (paramCpf: string): boolean => {
        ...
        const invalidCpf = Array.from(Array(10).keys()).map((n, index) =>
            index.toString().repeat(11),
        );
    ...
    cnpj: (paramCnpj: string): boolean => {
        ...
        const invalidCnpj = Array.from(Array(10).keys()).map((n, index) =>
            index.toString().repeat(14),
        );
